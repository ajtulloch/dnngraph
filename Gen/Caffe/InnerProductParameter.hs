...
import Control.Lens
data InnerProductParameter = InnerProductParameter{num_input :: !(P'.Maybe P'.Word32), num_output :: !(P'.Maybe P'.Word32),
                                                   bias_term :: !(P'.Maybe P'.Bool),
